...
@onready var season_status_title_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/LeftSummaryVBox/SeasonStatusTitleLabel
@onready var season_status_detail_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/LeftSummaryVBox/SeasonStatusDetailLabel
...
@onready var event_title_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/RightSummaryVBox/EventTitleLabel
@onready var event_detail_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/RightSummaryVBox/EventDetailLabel
@onready var digest_title_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/RightSummaryVBox/DigestTitleLabel
@onready var digest_detail_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/RightSummaryVBox/DigestDetailLabel
@onready var focus_team_title_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/LeftSummaryVBox/FocusTeamTitleLabel
@onready var focus_team_detail_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/LeftSummaryVBox/FocusTeamDetailLabel
@onready var today_title_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/LeftSummaryVBox/TodayTitleLabel
@onready var today_detail_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/LeftSummaryVBox/TodayDetailLabel
@onready var yesterday_title_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/RightSummaryVBox/YesterdayTitleLabel
@onready var yesterday_detail_label: Label = $RootScroll/MarginContainer/RootVBox/SummaryColumns/RightSummaryVBox/YesterdayDetailLabel
